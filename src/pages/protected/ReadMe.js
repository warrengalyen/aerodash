    ...
    return(
        <>
            <article className="prose">
                ...
                <p>Aerodash is a free template for dashboard project using tailwind CSS and react js. With the help of Daisy UI, it comes with fully customizable and themable CSS. It also comes with redux toolkit configured. </p>
